...
#include <windef.h>
#include <C:\Programs\Project\Include\Shared\winapifamily.h>
...
(
    ...
    LPWSTR                      pRenderCount,       // Size of render device ID string buffer (in wide-chars)
    LPWSTR pCaptureDeviceId,   // Windows Core Audio device ID string for capture (microphone)
    LPWSTR                      pCaptureCount       // Size of capture device ID string buffer (in wide-chars)
);
